...
<div class="page-container">
    ...
    <form id="loginfrom">
        ...
        <input type="text" name="kehupassword" class="username" placeholder=" 手机号">
        <input type="text" name="kehupassword" class="username" placeholder="身份证">
        <input type="text" name="kehupassword" class="username" placeholder="邮箱">
        <input type="password" name="kehupassword" class="password" placeholder="密码">
        <input type="password" name="kehupassword" class="password" placeholder="确认密码">
