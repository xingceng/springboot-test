...
<jsp:include page="/jquery/indexj/bootstjs.jsp"></jsp:include>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            url: "queryfangyuan?housetype=1&page=0&rows=9",
    ...
    $(document).on("change",'select#property-sort-dropdown',function(){
        var status=$(this).val()
        $.ajax({
            url: "queryershouofangbydate?housetype=1&page=0&rows=9&status="+status,
            data:{},
            success: function (data) {
                var op = "";
                for (var i = 0; i < data.length; i++) {
